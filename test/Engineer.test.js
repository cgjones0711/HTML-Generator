...
describe(`Engineer`,() => {
    ...
    it ("should return a id when I pass an id to Engineer", () => {
            let engineerId = "002";
            let newEngineerId = new Engineer("" ,engineerId);
                expect (newEngineerId.id).toBe("002");
    });
    
    it ("should return a email when I pass an email to Engineer", () => {
    ...
    it ("should return a github when I pass a github to Engineer", () => {
